"""
Tests for ai.ollama.get_ollama_status — fully mocked, no real Ollama
instance required and no network access used.
"""
...
from ai.ollama import get_ollama_status  # noqa: E402
...
def test_valid_response_reports_online_with_models(mock_get):
    mock_get.return_value = _make_response(
        {"models": [{"name": "qwen2.5"}, {"name": "llama3.2"}]}
    )
